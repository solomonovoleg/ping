#!/usr/bin/env node
"use strict";
/** migrations/0031_feed_global_snapshot.sql */
...
const sqlPath = path.join(process.cwd(), "migrations/0031_feed_global_snapshot.sql");
...
async function main() {
  ...
  try {
    ...
    console.log("feed_global_snapshot ready");
  } finally {
    await client.end();
  }
}
