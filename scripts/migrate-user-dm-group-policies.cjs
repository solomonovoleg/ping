#!/usr/bin/env node
"use strict";
/** migrations/0027_user_dm_group_policies.sql */
...
const sqlPath = path.join(process.cwd(), "migrations/0027_user_dm_group_policies.sql");
...
async function main() {
  ...
  try {
    ...
    console.log("user dm_policy / group_add_me_policy ready");
  } finally {
    await client.end();
  }
}
