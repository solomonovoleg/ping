...
"use strict";
/**
 * dm_scheduled_calls — баннер «запланирован звонок» в личке.
 * migrations/0030_dm_scheduled_calls.sql
 */
...
const sqlPath = path.join(process.cwd(), "migrations/0030_dm_scheduled_calls.sql");
...
async function main() {
  ...
  try {
    ...
    console.log("dm_scheduled_calls ready");
  } finally {
    await client.end();
  }
}
