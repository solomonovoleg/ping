...
"use strict";
/**
 * posts.content_interests, content_interests_at — см. migrations/0047_posts_content_interests.sql
 */
...
const sqlPath = path.join(process.cwd(), "migrations/0047_posts_content_interests.sql");
...
async function main() {
  ...
  try {
    ...
    console.log("OK migrate-posts-content-interests");
  } finally {
    await client.end();
  }
}
