#!/usr/bin/env node
"use strict";
/** migrations/0040_admin_media_studio.sql, 0041_admin_media_studio_campaign_title.sql */
...
const SQL_FILES = [
  "migrations/0040_admin_media_studio.sql",
  "migrations/0041_admin_media_studio_campaign_title.sql",
];
...
async function main() {
  ...
  try {
    for (const rel of SQL_FILES) {
      ...
      console.log("admin media studio:", rel, "ok");
    }
    console.log("admin media studio schema ready");
  } finally {
    await client.end();
  }
}
