#!/usr/bin/env node
"use strict";
/** migrations/0042_content_reports_context.sql */
...
const sqlPath = path.join(process.cwd(), "migrations/0042_content_reports_context.sql");
...
async function main() {
  ...
  try {
    ...
    console.log("content_reports.context_post_id + context_chat_id ready");
  } finally {
    await client.end();
  }
}
