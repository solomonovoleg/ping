#!/usr/bin/env node
"use strict";
/** migrations/0037_referral_program_settings.sql */
...
const sqlPath = path.join(process.cwd(), "migrations/0037_referral_program_settings.sql");
...
async function main() {
  ...
  try {
    ...
    console.log("referral program settings ready");
  } finally {
    await client.end();
  }
}
