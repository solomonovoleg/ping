#!/usr/bin/env node
"use strict";
/** migrations/0043_content_reports_reason_code.sql */
...
const sqlPath = path.join(process.cwd(), "migrations/0043_content_reports_reason_code.sql");
...
async function main() {
  ...
  try {
    ...
    console.log("content_reports.reason_code ready");
  } finally {
    await client.end();
  }
}
