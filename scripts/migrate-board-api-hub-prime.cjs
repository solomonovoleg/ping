#!/usr/bin/env node
"use strict";
/** migrations/0034_users_board_api_hub_prime_code.sql */
...
const sqlPath = path.join(process.cwd(), "migrations/0034_users_board_api_hub_prime_code.sql");
...
async function main() {
  ...
  try {
    ...
    console.log("users.board_api_hub_prime_code ready");
  } finally {
    await client.end();
  }
}
