...
"use strict";
/**
 * posts.edge_id для кампаний EDGE.
 * migrations/0023_posts_edge_id.sql
 */
...
const sqlPath = path.join(process.cwd(), "migrations/0023_posts_edge_id.sql");
...
async function main() {
  ...
  try {
    ...
    console.log("OK migrate-posts-edge-id");
  } finally {
    await client.end();
  }
}
