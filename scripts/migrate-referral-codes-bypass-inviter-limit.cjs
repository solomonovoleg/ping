#!/usr/bin/env node
"use strict";
/** migrations/0032_referral_codes_bypass_inviter_limit.sql */
...
const sqlPath = path.join(process.cwd(), "migrations/0032_referral_codes_bypass_inviter_limit.sql");
...
async function main() {
  ...
  try {
    ...
    console.log("referral_codes.bypass_inviter_limit ready");
  } finally {
    await client.end();
  }
}
