...
const CONTACTS = [
  { id: 1, name: "Алексей Иванов", status: "был(а) недавно", avatar: "https://i.pravatar.cc/150?u=11", letter: "А" },
  { id: 2, name: "Алиса Смирнова", status: "в сети", avatar: "https://i.pravatar.cc/150?u=1", letter: "А" },
  { id: 3, name: "Борис Ельцин", status: "был(а) в 14:00", avatar: "https://i.pravatar.cc/150?u=12", letter: "Б" },
  { id: 4, name: "Виктория Секрет", status: "в сети", avatar: "https://i.pravatar.cc/150?u=13", letter: "В" },
  { id: 5, name: "Григорий Лепс", status: "был(а) вчера", avatar: "https://i.pravatar.cc/150?u=14", letter: "Г" },
  { id: 6, name: "Дмитрий Нагиев", status: "в сети", avatar: "https://i.pravatar.cc/150?u=15", letter: "Д" },
  { id: 7, name: "Елена Ваенга", status: "печатает...", avatar: "https://i.pravatar.cc/150?u=16", letter: "Е" },
];
