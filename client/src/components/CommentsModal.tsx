    ...
    <AnimatePresence>
      {isOpen && [
        <motion.div
          ...
          className="fixed inset-0 w-full bg-black/40 z-[200] backdrop-blur-sm"
        ...
        <motion.div
          ...
          className="fixed bottom-0 left-0 right-0 w-full max-w-[480px] mx-auto z-[201] bg-background rounded-t-3xl flex flex-col shadow-2xl max-h-[85dvh] min-h-[40dvh] h-[75dvh] pt-[env(safe-area-inset-top,0px)]"
        ...
        <div className="flex-1 min-h-0 overflow-y-auto p-4 flex flex-col gap-4">
          {loading ? (
            ...
            <ListEmptyState
              ...
              description="Оставьте первый комментарий в поле ниже"
              className="py-8"
            />
          ) : (
